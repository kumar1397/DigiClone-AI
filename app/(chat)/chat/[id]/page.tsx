          ...
          {chatHistory.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
              <div className="max-w-2xl space-y-6">
                <h2 className="text-4xl font-bold text-[#0e0000]">Welcome to DigiClone AI</h2>
                <p className="text-xl text-gray-600">
                  I&apos;m here to help you learn and grow. How can I assist you today?
                </p>
                ...
                {chat.bot && (
                  <div className="flex justify-start">
                    <div className="text-[#fff9f9] whitespace-pre-wrap max-w-[75%] space-y-4">
                      {/* Sources block */}
                      {typeof chat.bot.sources === 'string' && chat.bot.sources.trim() !== "" && (
