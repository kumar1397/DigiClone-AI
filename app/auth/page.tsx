        ...
        <Card className="border-0 shadow-xl backdrop-blur-sm bg-card/80">
          <CardHeader className="space-y-3 text-center pb-8">
            ...
            <CardDescription className="text-base">
              Continue with your Google account to access your digital clone dashboard
            </CardDescription>
          </CardHeader>

          <CardContent className="space-y-6 px-8 pb-8">
            <Button
              className="w-full h-14 text-base font-medium bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 shadow-sm transition-all duration-200 hover:shadow-md"
